...
export default function ExchangePlace({ navigation }: any) {
    ...
    const fetchSeries = () => {
        ...
        // TODO : importer données collection-api => to_exchange
    };
    ...
    return (
        <View style={styles.exchangePlace} onLayout={onLayoutRootView}>
            <ImageBackground
